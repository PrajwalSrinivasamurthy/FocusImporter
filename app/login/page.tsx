...
export default function LoginPage() {
  ...
  // Redirect anyone who hits /login to the main app.
  useEffect(() => {
...
// Previous full login page (kept commented out per request):
//
// "use client";
//
...
//         </div>
//
//         {/* Keep a form wrapper for semantics, but drive login via explicit button click */}
